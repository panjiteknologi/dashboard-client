...
export default function EditLibraryVideoPage() {
  ...
  const videoId = params.videoId as Id<"libraryVideos">;

  const video = useQuery(api.libraryVideos.get, { id: videoId });
  const updateMutation = useMutation(api.libraryVideos.update);
  ...
  const currentSubCategory = useQuery(
    ...
    video?.subCategoryId ? { id: video.subCategoryId } : "skip"
  );
      ...
      <div className="flex flex-col gap-4 p-4 pt-0">
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">Edit Library Video</h1>
          </div>
