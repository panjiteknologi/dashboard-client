  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        ...
        {/* Projects Table */}
        <Card className="shadow-lg border-0 bg-linear-to-br from-slate-50 to-blue-50/30">
          <CardHeader className="to-indigo-600  rounded-t-lg">
            <div className="flex items-center gap-4">
